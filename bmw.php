    ...
    <h3 class="text-center">Cars</h3>
        ...
        <div class="d-flex justify-content-evenly mt-2">
         <div class="card mb-3" style="width: 22rem;">
            <img src="cars/bmw1.jpg" class="card-img-top" alt="Honda amaze">
            <div class="card-body">
          ...
          <div class="card mb-3" style="width: 22rem;">
            <img src="cars/bmw2.jpg" class="card-img-top" alt="Honda amaze">
            <div class="card-body">
          ...
          <div class="card mb-3" style="width: 22rem;">
            <img src="cars/bmw3.webp" class="card-img-top" alt="Honda amaze">
            <div class="card-body">
              <h5 class="card-title">BMW 7 SERIES SEDAN</h5>
          ...
          <div class="card mb-3" style="width: 22rem;">
            <img src="cars/bmw4.jpg" class="card-img-top" alt="Honda amaze">
            <div class="card-body">
              <h5 class="card-title">BMW M4 Competition Coupé with M xDrive</h5>
