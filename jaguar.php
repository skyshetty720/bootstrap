    ...
    <h3 class="text-center">Cars</h3>
        ...
        <div class="d-flex justify-content-evenly mt-2">
         <div class="card mb-3" style="width: 22rem;">
            <img src="cars/jaguarfpace.jpg" class="card-img-top" alt="Honda amaze">
            <div class="card-body">
              <h5 class="card-title">Jaguar F-PACE</h5>
              <p class="card-text">
          ...
          <div class="card mb-3" style="width: 22rem;">
            <img src="cars/fpacesvr.webp" class="card-img-top" alt="Honda amaze">
            <div class="card-body">
              <h5 class="card-title">Jaguar F-PACE SVR</h5>
          ...
          <div class="card mb-3" style="width: 22rem;">
            <img src="cars/jaguar3.webp" class="card-img-top" alt="Honda amaze">
            <div class="card-body">
              <h5 class="card-title">JAGUAR XF</h5>
              <p class="card-text">Jaguar XF captures attention from every angle. Contemporary features, including the foil tipped grille, are part of Jaguar XF’s enhanced exterior.
            </p>
            </div>
            <div class="card-body">
          ...
          <div class="card mb-3" style="width: 22rem;">
            <img src="cars/ftype.webp" class="card-img-top" alt="Honda amaze">
            <div class="card-body">
              <h5 class="card-title">JAGUAR F‑TYPE</h5>
              <p class="card-text">F‑TYPE is Jaguar design in its most athletic form — lean, and elegant from any angle.
            </p>
            </div>
            <div class="card-body">
