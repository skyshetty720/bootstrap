    ...
    <h3 class="text-center">Bikes</h3>
        ...
        <div class="d-flex justify-content-evenly mt-2">
         <div class="card mb-3" style="width: 22rem;">
            ...
            <div class="card-body">
              <a href="buynow.php?car=KTM 250 DUKE" class="card-link btn btn-primary">Buy Now</a>
          ...
          <div class="card mb-3" style="width: 22rem;">
            ...
            <div class="card-body">
              <a href="buynow.php?car=KTM 390 ADVENTURE" class="card-link btn btn-primary">Buy Now</a>
          ...
          <div class="card mb-3" style="width: 22rem;">
            ...
            <div class="card-body">
              <a href="buynow.php?car=KTM RC 200 " class="card-link btn btn-primary">Buy Now</a>
