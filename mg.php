...
<body style="font-family: 'Ropa Sans',sans-serif;">
    ...
    <section>
        <div class="card mb-3">
            ...
            <div class="card-body">
              <h5 class="card-title">MG Motor UK Limited</h5>
              <p class="card-text" style="font-size: 19px;">
                MG Motor UK Limited (MG Motor) is a British automotive company owned by SAIC Motor UK, which in turn is owned by the Shanghai-based Chinese state-owned company, SAIC Motor, headquartered in London, United Kingdom. MG Motor designs, develops and markets cars sold under the MG marque, while vehicle manufacturing takes place at its plants in China, Thailand, and India. The design of the cars was originally engineered by MG Motors in Longbridge, Birmingham, United Kingdom.    
            </p></div>
          </div>
    </section>
<section>
    <h3 class="text-center">Cars</h3>
        ...
        <div class="d-flex justify-content-evenly mt-2">
         <div class="card mb-3" style="width: 22rem;">
            <img src="cars/astor.webp" class="card-img-top" alt="Honda amaze">
            <div class="card-body">
              <h5 class="card-title">ASTOR</h5>
              <p class="card-text">
                MG ASTOR'S 80+ CONNECTED CAR FEATURES MAKE IT A PLATFORM, WHERE YOU CAN EXPLORE NEW POSSIBILITIES ENDLESSLY.
            </p>
            </div>
            <div class="card-body">
          ...
          <div class="card mb-3" style="width: 22rem;">
            <img src="cars/hector.webp" class="card-img-top" alt="Honda amaze">
            <div class="card-body">
